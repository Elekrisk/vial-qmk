...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x15(
		XXXXXXX,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,MO(5),  TG(4),  KC_BSPC,
		KC_TAB ,KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   XXXXXXX,XXXXXXX,XXXXXXX,KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,
		CAPS   ,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   XXXXXXX,XXXXXXX,KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,
		KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   XXXXXXX,XXXXXXX,XXXXXXX,KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,
		KC_LCTL,XXXXXXX,KC_LGUI,KC_LALT,KC_SPC ,KC_SPC ,TL_LOWR,XXXXXXX,TL_UPPR,KC_ENT ,KC_BSPC,KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT
	),
	[1] = LAYOUT_ortho_5x15(
		...
		_______,LCTL(KC_Z)   ,LCTL(KC_X)   ,KC_LGUI      ,LCTL(KC_V)   ,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
		_______,_______      ,_______      ,_______      ,_______      ,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______
	),
	[2] = LAYOUT_ortho_5x15(
		_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
		_______,LSFT(KC_1),LSFT(KC_2),LSFT(KC_3),RALT(KC_4),LSFT(KC_5),_______,_______,_______,_______,_______,_______,_______,_______,_______,
		_______,RALT(KC_2),LSFT(KC_6),RALT(KC_MINS),LSFT(KC_7),_______,_______,_______,_______,_______,LSFT(KC_8),RALT(KC_7),RALT(KC_8),_______,_______,
		_______,KC_NUBS,LSFT(KC_NUBS),RALT(KC_NUBS),_______,_______,_______,_______,_______,_______,LSFT(KC_9),RALT(KC_0),RALT(KC_9),_______,_______,
		_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______
	),
	[3] = LAYOUT_ortho_5x15(
		_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
